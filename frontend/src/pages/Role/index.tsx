...
const RoleList = () =>{
    ...
    const HandleDelete = (e:any) => {
        ...
        Swal.fire({
          ...
          confirmButtonText: 'Delete',
            ...
            if(result.isConfirmed===true){
                axios.delete(`${process.env.REACT_APP_URL}/admin/roles/delete/${e}`, {headers: {'token':`${localStorage.getItem('Token')}`} })
                .then((res)=>{
                   if (res.status===200) {
                       Swal.fire({
      ...
      const HandleEdit=(e:any)=>{
        Navigate("/admin/roles/edit",{state:e});
      }
        ...
        <div className="breadcrumb-two mb-3 d-flex justify-content-between" >
            ...
            <button className='btn btn-primary btn-rounded py-0'>
                <div className='d-flex'>
                    ...
                    <h5 className='text-white mb-0'onClick={()=>Navigate('/admin/roles/store')}>Add</h5>
                </div>
            </button>
        </div>
                        ...
                        <div className="row">
                            <div className="col-sm-12">
                                <table id="default-ordering" className="table table-hover dataTable" style={{width:"100%"}} role="grid" aria-describedby="default-ordering_info">
                                    <thead>
                                        <tr role="row">
                                            <th className="sorting col-2" tabIndex={0} rowSpan={1} colSpan={1}>Name</th>
                                    ...
                                    <tbody>
                                    {roles?.Role?.length!==0?<>
                                        {roles?.Role?.map((user:any,index:number)=>(
